/*
a sample java SIMPL receiver SIMPL communicating with a java sender
*/

class ReceiverScharacter
	{
	public static void main(String arg[])
		...
		*/
		ret = simpl.nameAttach(50000, "localhost", "RECEIVER");
		if (ret == -1)
			{
	...
	static void unpackInput(Ssimpl simpl)
		{
	...
	static void packOutput(Ssimpl simpl)
		{
		int ret;
