...
DESCRIPTION:	This file contains the function calls (C wrappers)
				...
				It is meant for use with python version 3 only.
...
Revision history:
====================================================================
$Log: simpl3module.c,v $
Revision 1.1  2013/06/18 14:33:07  bobfcsoft
new
...
CALLED AS:	msgSize, senderId = simpl.receive(inBuffer)
...
// parse out the passed in arguments
if (PyArg_ParseTuple(args, "z#", &inMem, &inSize))
	{
	// call the actual simpl C library function
	ret = Receive(&sender, inMem, inSize);
	}
else
	{
	_simpl_setErrorCode(COMMAND_LINE_ERROR);
...
static PyMethodDef simplMethods[] =
	{
	{"nameAttach", simpl_nameAttach, METH_VARARGS, NULL},
	{"nameDetach", simpl_nameDetach, METH_NOARGS, NULL},
	{"surDetach", simpl_surDetach, METH_VARARGS, NULL},
	{"nameLocate", simpl_nameLocate, METH_VARARGS, NULL},
	{"receive", simpl_receive, METH_VARARGS, NULL},
	{"send", simpl_send, METH_VARARGS, NULL},
	{"trigger", simpl_trigger, METH_VARARGS, NULL},
	{"reply", simpl_reply, METH_VARARGS, NULL},
	{"whatsMyReceiveFd", simpl_whatsMyReceiveFd, METH_NOARGS, NULL},
	{"whatsMyError", simpl_whatsMyError, METH_NOARGS, NULL},
	{"returnProxy", simpl_returnProxy, METH_VARARGS, NULL},
	{"returnModuleVersion", simpl_returnModuleVersion, METH_NOARGS, NULL},
	{NULL, NULL, 0, NULL}
	};

/************************ module definition **************************/

static struct PyModuleDef simpl3module =
	{
...
PyMODINIT_FUNC PyInit_simpl3()
{
return( PyModule_Create(&simpl3module) );
}
