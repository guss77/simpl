"""
packAll: this program tests the packing/unpacking methods attached to a class
instance of simpl. The C variable types are somewhat unorganized on purpose but
all are used at least once.

This program also serves as a good exqample of the pack and unpack a message.
