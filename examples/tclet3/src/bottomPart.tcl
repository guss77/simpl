...
#
# Locate the rpcServer
#
set toWhom [vc_name_locate $mySocket $rpcName]

#
# Connect to the trace logger
#
...
vc_logit $mySocket $logger $this $fn $MASK_MISC $logMask [format "rpcName=%s id=%d" $rpcName $toWhom]

button $b.quit -text "quit" -command quitThis
pack $b.quit -side right

button $b.test -text "test" -command testThis
pack $b.test -side left
